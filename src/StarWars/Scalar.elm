...
module StarWars.Scalar exposing (Codecs, Id(..), PosixTime(..), defaultCodecs, defineCodecs, unwrapCodecs, unwrapEncoder)
...
unwrapEncoder :
    (RawCodecs valueId valuePosixTime -> Codec getterValue)
    -> Codecs valueId valuePosixTime
    -> getterValue
